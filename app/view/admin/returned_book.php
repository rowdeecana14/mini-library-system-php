                ...
                <form id="form-filter">
                  <div class="row col-10 offset-1">
                    ...
                    <div class="col-md-4 col-xs-12">
                       ...
                       <div class="form-group">
                          <label for="due_date">DATE RETURN: </label>
                          <input type="date" class="form-control filter-option" id="return_date" name="return_date" placeholder="Due date" required>
                        </div>
                    </div>
              ...
              <div class="card-header">
                <h3 class="card-title">
                  <div class=" d-flex">
                    ...
                    <div class="ml-1 mt-1" style="font-weight: bold">LIST OF RETURNED BOOK</div> 
                  </div>
                </h3>
                <div class="card-tools">
...
<script type="text/javascript">
  ...
  $('#book-returned-item').addClass('active');
  ...
  $('.filter-option').change(function() {
    ...
    getFilter(rent_date, return_date, user_id);
  });
  ...
  function displayList(prev, next) {
    ...
    if(data.length > prev) {
      for(let i = prev; i < next; i++) {
        console.log(data[i].diff_date, 0)
  ...
  function getFilter(rent_date, return_date, user_id) {
    try {

        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Returned book</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid --> 
        ...
        <div class="row">
          ...
          <div class="col-12">
                  ...
                  <div class="row col-10 offset-1">
                    ...
                    <div class="col-md-4 col-xs-12">
                       ...
                       <div class="form-group">
                          <label for="rent_date">DAY: </label>
                          <input type="date" class="form-control filter-option" id="date" name="date" placeholder="Date rent" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-xs-12">
                       ...
                       <div class="input-group mb-4">
                        <label for="genre">MONTH: </label>
                        <select class="form-control select2 filter-option" id="month" name="month"  style="width: 100%;">
                    ...
                    <div class="col-md-4 col-xs-12">
                       ...
                       <div class="input-group mb-4">
                        ...
                        <select class="form-control select2 filter-option" id="year" name="year"  style="width: 100%;">
                        </select>
                      </div>
                    </div>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  <div class=" d-flex">
                    ...
                    <div class="ml-1 mt-1" style="font-weight: bold">RENTED AND RETURNED</div> 
                  </div>
                </h3>
                <div class="card-tools">
              ...
              <div class="card-body">
                <div class="col-12">
                    <h4 id="record-title">Yearly record: <?php echo date('Y'); ?></h4>
...
<script type="text/javascript">
  ...
  function loadInit() {
    try {
      ...
      query.param = { action: 'admin-returned-list' };
      response = query.run();
  ...
  function getFilter(date, month, year) {
    try {

        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Overdue book</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid --> 
              ...
              <div class="card-header">
                <h3 class="card-title">
                  <div class=" d-flex">
                    ...
                    <div class="ml-1 mt-1" style="font-weight: bold">LIST OF OVERDUE BOOK</div> 
                  </div>
                </h3>
                <div class="card-tools">
...
<script type="text/javascript">
  ...
  $('#book-overdue-item').addClass('active');
  ...
  function loadInit() {
    try {
      ...
      query.param = { action: 'admin-overdue-list' };
      response = query.run();
  ...
  function displayList(prev, next) {
    ...
    if(data.length > prev) {
      for(let i = prev; i < next; i++) {
        status = '<span class="badge bg-warning p-2">' + data[i].diff_date + ' day(s)</span>';
